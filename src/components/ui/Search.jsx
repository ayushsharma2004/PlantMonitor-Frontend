        ...
        <div className="search_container">
            <div className="search-panels">
                <div className="search-group">
                    <input required type="search" name="text" placeholder="Search by name, email or location" autoComplete="on" maxLength={35} className="input" />
